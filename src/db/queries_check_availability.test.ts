...
const OTHER_BUSINESS_ID = "A023BCC5-B2A4-41C5-AB32-CF145D536D61" // Wellness Medical Center
...
describe("check_availability", () => {
  ...
  test("returns_null_when_no_matching_slot_exists", () => {
    //  --  act
    const result = check_availability(BUSINESS_ID, "2026-05-01", "19:00", 2)
  ...
  test("returns_slot_when_sufficient_capacity_is_available", () => {
    ...
    //  --  act
    const result = check_availability(BUSINESS_ID, "2026-05-01", "19:00", 4)
  ...
  test("returns_slot_when_party_size_exactly_matches_remaining_capacity", () => {
    ...
    //  --  act
    const result = check_availability(BUSINESS_ID, "2026-05-02", "20:00", 2)
  ...
  test("returns_null_when_remaining_capacity_is_less_than_party_size", () => {
    ...
    const result = check_availability(BUSINESS_ID, "2026-05-03", "12:00", 2)
  ...
  test("returns_null_when_slot_is_fully_booked", () => {
    ...
    //  --  act
    const result = check_availability(BUSINESS_ID, "2026-05-04", "09:00", 1)
  ...
  test("returns_null_when_business_id_does_not_match", () => {
    //  --  arrange
    seed_slot(test_db, BUSINESS_ID, "2026-05-05", "18:00", 10)

    //  --  act (query with a different business)
    const result = check_availability(OTHER_BUSINESS_ID, "2026-05-05", "18:00", 1)
