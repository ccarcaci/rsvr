...
import { mock_anthropic_client } from "./client/mock"
import { parse_intent } from "./intent"
...
describe("parse_intent", () => {
  ...
  it("should parse a cancellation intent", async () => {
    mock_anthropic_client('{"action":"cancel","reservation_id":42}')
  ...
  it("should return unknown for unparseable responses", async () => {
    mock_anthropic_client("I'm not sure what you mean")
